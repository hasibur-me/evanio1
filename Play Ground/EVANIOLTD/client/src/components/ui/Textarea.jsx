...
export const Textarea = ({ className, glass = false, ...props }) => {
  if (glass) {
    return (
      <textarea
        className={cn(
  ...
  return (
    <textarea
      className={cn(
        'w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 transition-colors duration-300',
        className
      )}
      {...props}
    />
